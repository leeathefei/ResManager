...
TIPS：如果修改了xml文件，重新加载发现crash。xml实例读取异常，说明是xml格式有问题。请排查xml格式是否正确。
...
TIPS:给pane设置标题的函数是：m_wndStatusBar.SetPaneText(0, _T("这是工程二的状态栏"));
