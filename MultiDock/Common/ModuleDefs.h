...
enum EPANE_ALIGNMENT
{
   ...
   ALIGN_LEFT		 ,//CBRS_ALIGN_LEFT,//始终靠左停靠，不组合。
   ALIGN_RIGHT		 ,//CBRS_ALIGN_RIGHT,
   ALIGN_TOP		 , //CBRS_ALIGN_TOP,
   ALIGN_BOTTON		 , //CBRS_ALIGN_BOTTOM,
   ALIGN_LEFT_GROUP  , //CBRS_ALIGN_LEFT,//靠左停靠，与之前的左边pane全部在一组。
   ALIGN_RIGHT_GROUP , //CBRS_ALIGN_RIGHT,
   ALIGN_TOP_GROUP	 , //CBRS_ALIGN_TOP,
   ALIGN_BOTTOM_GROUP //CBRS_ALIGN_BOTTOM,
};
...
struct MODULE_WINDOW_DEF {
   ...
   MODULE_WINDOW_DEF() {
      ...
      bAutoDelete = true;
      bAttachToPrev = true;
      nEnabledAlign = ALIGN_RIGHT_GROUP;
   }
