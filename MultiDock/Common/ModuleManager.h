...
public:
   ...
   virtual BOOL RegisterModulePane(CWnd* pWnd=NULL, LPCTSTR lpszWndName=NULL, HICON hIcon=NULL,
	   EPANE_ALIGNMENT align=ALIGN_RIGHT_GROUP, bool bAttachToPrev=true, bool bAutoDelete=true,CRect rect=CRect(0,0,0,0));
